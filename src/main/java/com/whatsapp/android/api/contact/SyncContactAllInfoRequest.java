 ...
 */
public class SyncContactAllInfoRequest extends AbstractRequest<SyncContactResult> {
    private final SyncContactPack syncContactPack;

    public SyncContactAllInfoRequest(SyncContactPack syncContactPack) {
        this.syncContactPack = syncContactPack;
    }

    @Override
    public String funcName() {
        return TypeConstant.TaskType.SYNC_CONTACT_ALL_INFO;
    }
    ...
    public boolean request() {
        ...
        ProtocolTreeNode protocolTreeNode = user.getGorgeousEngine().generateContactNodeAllInfo(list, getTaskId(), "background");
