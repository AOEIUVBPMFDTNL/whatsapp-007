...
import com.whatsapp.android.api.contact.TrustedContactRequest;
 ...
 */
@Service
@ApiType(TypeConstant.TaskType.TRUSTED_CONTACT)
public class TrustedContactService implements ApiStrategy {
    @Override
    public Result execute(String type, JSONObject dataObject, String taskId, User user) {
        String userId = dataObject.getJSONObject("data").getString("userId");
        String username = user.getLoginPack().getUsername();
        StatusResult statusResult = user.sendRequest(new TrustedContactRequest(userId));
