 ...
 */
@Service
@ApiType(TypeConstant.TaskType.BATCH_SEND_MESSAGE)
public class BatchSendMessageService implements ApiStrategy {
    @Override
    public Result execute(String type, JSONObject dataObject, String taskId, User user) {
        ...
        BatchSendMessageResult batchSendMessageResult = user.sendRequest(new BatchSendMessageRequest(data));
