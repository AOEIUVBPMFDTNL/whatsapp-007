...
import com.whatsapp.android.api.contact.SyncContactAllInfoRequest;
 ...
 */
@Service
@ApiType(TypeConstant.TaskType.SYNC_CONTACT_ALL_INFO)
public class SyncContactAllInfoService implements ApiStrategy {
    @Override
    public Result execute(String type, JSONObject dataObject, String taskId, User user) {
        SyncContactPack data = dataObject.getObject("data", SyncContactPack.class);
        String username = user.getLoginPack().getUsername();
        SyncContactResult syncContactResult = user.sendRequest(new SyncContactAllInfoRequest(data));
