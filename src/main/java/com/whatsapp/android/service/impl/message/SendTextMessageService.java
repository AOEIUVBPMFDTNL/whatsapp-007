...
import com.whatsapp.android.api.message.SendTextMessageRequest;
 ...
 */
@Service
@ApiType(TypeConstant.TaskType.SEND_TEXT_MESSAGE)
public class SendTextMessageService implements ApiStrategy {
    ...
    private Result execute(User user, String username, String type, MessagePack data, String taskId) {
        SendMessageResult sendMessageResult = user.sendRequest(new SendTextMessageRequest(data));
