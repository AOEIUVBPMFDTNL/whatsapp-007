...
import com.whatsapp.android.api.contact.QueryContactAllInfoRequest;
 ...
 */
@Service
@ApiType(TypeConstant.TaskType.QUERY_CONTACT_ALL_INFO)
public class QueryContactAllInfoService implements ApiStrategy {
    @Override
    public Result execute(String type, JSONObject dataObject, String taskId, User user) {
        SyncContactPack data = dataObject.getObject("data", SyncContactPack.class);
        String username = user.getLoginPack().getUsername();
        SyncContactResult syncContactResult = user.sendRequest(new QueryContactAllInfoRequest(data));
