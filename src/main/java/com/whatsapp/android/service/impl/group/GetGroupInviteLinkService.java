 ...
 */
@Service
@ApiType(TypeConstant.TaskType.GET_GROUP_INVITE_LINK)
public class GetGroupInviteLinkService implements ApiStrategy {
    @Override
    public Result execute(String type, JSONObject dataObject, String taskId, User user) {
        CreateGroupPack data = dataObject.getObject("data", CreateGroupPack.class);
        String username = user.getLoginPack().getUsername();
        CreateGroupResult createGroupResult = user.sendRequest(new GetGroupInviteLinkRequest(data, false));
