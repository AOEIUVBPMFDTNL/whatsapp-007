package com.whatsapp.android.util.cron;
...
import com.whatsapp.android.util.cron.listener.TaskListener;
import com.whatsapp.android.util.cron.listener.TaskListenerManager;
import com.whatsapp.android.util.cron.pattern.CronPattern;
import com.whatsapp.android.util.cron.task.InvokeTask;
import com.whatsapp.android.util.cron.task.RunnableTask;
...
public class Scheduler implements Serializable {
     ...
     */
    protected StandardThreadExecutor threadExecutor;
     ...
     * @return this
     */
    public Scheduler start(boolean isDaemon, StandardThreadExecutor threadExecutor) {
        this.daemon = isDaemon;
        return start(threadExecutor);
    }
     ...
     * @return this
     */
    public Scheduler start(StandardThreadExecutor threadExecutor) {
        lock.lock();
        try {
            if (this.started) {
