...
public class KeyHelper {
  ...
  public static ECPrivateKey decodePrivateKey(byte[] priKey) {
    return  Curve.decodePrivatePoint(priKey);
  }
  ...
  public static int generateRegistrationId(boolean extendedRange) {
    try {
      ...
      if (extendedRange) return secureRandom.nextInt(2147483646 - 1) + 1;
